"""
Oracle PG implementation for next-episode edge operations.
"""
...
from graphiti_core.edges import NextEpisodeEdge, get_next_episode_edge_from_record


class OraclePGNextEpisodeEdgeOperations(NextEpisodeEdgeOperations):
    def __init__(self) -> None:
        self._store = OraclePGSimpleEdgeStore('next_episode_edges', get_next_episode_edge_from_record)
