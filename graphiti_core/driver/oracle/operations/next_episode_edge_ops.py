...
class OracleNextEpisodeEdgeOperations(NextEpisodeEdgeOperations):
    async def save(
        self,
        ...
        delete_query = 'DELETE FROM GRAPHITI_NEXT_EPISODE_EDGES WHERE UUID = $uuid'
        insert_query = """
            INSERT INTO GRAPHITI_NEXT_EPISODE_EDGES (
    ...
    async def delete(
        ...
        query = 'DELETE FROM GRAPHITI_NEXT_EPISODE_EDGES WHERE UUID = $uuid'
        if tx is not None:
    ...
    async def delete_by_uuids(
        ...
        query = f'DELETE FROM GRAPHITI_NEXT_EPISODE_EDGES WHERE {clause}'
        if tx is not None:
    ...
    async def get_by_uuid(
        ...
        query = """
            ...
            FROM GRAPHITI_NEXT_EPISODE_EDGES
            WHERE UUID = $uuid
        """
